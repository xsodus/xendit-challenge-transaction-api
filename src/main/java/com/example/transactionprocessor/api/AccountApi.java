...
public interface AccountApi {
    ...
    ResponseEntity<AccountResponseDTO> getAccountData(@PathVariable("accountId") Long accountId) throws InvalidInputError;
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid request", content = @Content),
            @ApiResponse(responseCode = "404", description = "Resource not found", content = @Content)})
    ResponseEntity<List<ProcessPaymentResponseDTO>> getTransactions(@PathVariable("accountId") Long accountId)

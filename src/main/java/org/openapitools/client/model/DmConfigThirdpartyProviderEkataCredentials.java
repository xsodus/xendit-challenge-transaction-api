 ...
 */
@JsonPropertyOrder({
  DmConfigThirdpartyProviderEkataCredentials.JSON_PROPERTY_API_KEY
})
@JsonTypeName("DmConfig_thirdparty_provider_ekata_credentials")
...
public class DmConfigThirdpartyProviderEkataCredentials {
  ...
  public DmConfigThirdpartyProviderEkataCredentials() {
  }

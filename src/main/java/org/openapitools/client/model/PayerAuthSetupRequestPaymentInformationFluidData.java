...
/**
 * PayerAuthSetupRequestPaymentInformationFluidData
 */
@JsonPropertyOrder({
  PayerAuthSetupRequestPaymentInformationFluidData.JSON_PROPERTY_VALUE,
  PayerAuthSetupRequestPaymentInformationFluidData.JSON_PROPERTY_KEY_SERIAL_NUMBER,
  PayerAuthSetupRequestPaymentInformationFluidData.JSON_PROPERTY_DESCRIPTOR,
  PayerAuthSetupRequestPaymentInformationFluidData.JSON_PROPERTY_ENCODING
})
@JsonTypeName("payerAuthSetup_request_paymentInformation_fluidData")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-11-09T18:32:10.370382+07:00[Asia/Bangkok]", comments = "Generator version: 7.9.0")
public class PayerAuthSetupRequestPaymentInformationFluidData {
  ...
  public PayerAuthSetupRequestPaymentInformationFluidData() {
  }

  public PayerAuthSetupRequestPaymentInformationFluidData value(String value) {
  ...
  public PayerAuthSetupRequestPaymentInformationFluidData keySerialNumber(String keySerialNumber) {
  ...
  public PayerAuthSetupRequestPaymentInformationFluidData descriptor(String descriptor) {
  ...
  public PayerAuthSetupRequestPaymentInformationFluidData encoding(String encoding) {
  ...
  public boolean equals(Object o) {
    ...
    PayerAuthSetupRequestPaymentInformationFluidData payerAuthSetupRequestPaymentInformationFluidData = (PayerAuthSetupRequestPaymentInformationFluidData) o;
    return Objects.equals(this.value, payerAuthSetupRequestPaymentInformationFluidData.value) &&
        Objects.equals(this.keySerialNumber, payerAuthSetupRequestPaymentInformationFluidData.keySerialNumber) &&
        Objects.equals(this.descriptor, payerAuthSetupRequestPaymentInformationFluidData.descriptor) &&
        Objects.equals(this.encoding, payerAuthSetupRequestPaymentInformationFluidData.encoding);
  }
  ...
  public String toString() {
    ...
    sb.append("class PayerAuthSetupRequestPaymentInformationFluidData {\n");

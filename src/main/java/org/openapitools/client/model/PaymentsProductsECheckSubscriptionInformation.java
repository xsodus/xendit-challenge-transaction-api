 ...
 */
@JsonPropertyOrder({
  PaymentsProductsECheckSubscriptionInformation.JSON_PROPERTY_ENABLED,
  PaymentsProductsECheckSubscriptionInformation.JSON_PROPERTY_SELF_SERVICEABILITY,
  PaymentsProductsECheckSubscriptionInformation.JSON_PROPERTY_MODE
})
@JsonTypeName("paymentsProducts_eCheck_subscriptionInformation")

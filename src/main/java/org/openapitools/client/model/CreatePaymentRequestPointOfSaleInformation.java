...
import org.openapitools.client.model.CreatePaymentRequestPointOfSaleInformationEmv;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.fasterxml.jackson.annotation.JsonTypeName;

/**
 * CreatePaymentRequestPointOfSaleInformation
 */
@JsonPropertyOrder({
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_TERMINAL_ID,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_TERMINAL_SERIAL_NUMBER,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_CARDHOLDER_VERIFICATION_METHOD_USED,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_LANE_NUMBER,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_CAT_LEVEL,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_ENTRY_MODE,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_TERMINAL_CAPABILITY,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_OPERATING_ENVIRONMENT,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_EMV,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_AMEX_CAPN_DATA,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_TRACK_DATA,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_STORE_AND_FORWARD_INDICATOR,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_CARDHOLDER_VERIFICATION_METHOD,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_TERMINAL_INPUT_CAPABILITY,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_TERMINAL_CARD_CAPTURE_CAPABILITY,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_TERMINAL_OUTPUT_CAPABILITY,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_TERMINAL_PIN_CAPABILITY,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_PIN_ENTRY_SOLUTION,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_DEVICE_ID,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_PIN_BLOCK_ENCODING_FORMAT,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_ENCRYPTED_PIN,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_ENCRYPTED_KEY_SERIAL_NUMBER,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_PARTNER_SDK_VERSION,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_EMV_APPLICATION_IDENTIFIER_AND_DEDICATED_FILE_NAME,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_TERMINAL_COMPLIANCE,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_IS_DEDICATED_HARDWARE_TERMINAL,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_TERMINAL_MODEL,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_TERMINAL_MAKE,
  CreatePaymentRequestPointOfSaleInformation.JSON_PROPERTY_SERVICE_CODE
})
@JsonTypeName("createPayment_request_pointOfSaleInformation")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-11-09T18:32:10.370382+07:00[Asia/Bangkok]", comments = "Generator version: 7.9.0")
public class CreatePaymentRequestPointOfSaleInformation {
  ...
  public static final String JSON_PROPERTY_LANE_NUMBER = "laneNumber";
  private String laneNumber;

  public static final String JSON_PROPERTY_CAT_LEVEL = "catLevel";
  ...
  public static final String JSON_PROPERTY_OPERATING_ENVIRONMENT = "operatingEnvironment";
  private String operatingEnvironment;

  public static final String JSON_PROPERTY_EMV = "emv";
  private CreatePaymentRequestPointOfSaleInformationEmv emv;
  ...
  public static final String JSON_PROPERTY_STORE_AND_FORWARD_INDICATOR = "storeAndForwardIndicator";
  private String storeAndForwardIndicator;

  public static final String JSON_PROPERTY_CARDHOLDER_VERIFICATION_METHOD = "cardholderVerificationMethod";
  private List<String> cardholderVerificationMethod = new ArrayList<>();

  public static final String JSON_PROPERTY_TERMINAL_INPUT_CAPABILITY = "terminalInputCapability";
  private List<String> terminalInputCapability = new ArrayList<>();

  public static final String JSON_PROPERTY_TERMINAL_CARD_CAPTURE_CAPABILITY = "terminalCardCaptureCapability";
  private String terminalCardCaptureCapability;

  public static final String JSON_PROPERTY_TERMINAL_OUTPUT_CAPABILITY = "terminalOutputCapability";
  private String terminalOutputCapability;

  public static final String JSON_PROPERTY_TERMINAL_PIN_CAPABILITY = "terminalPinCapability";
  private Integer terminalPinCapability;

  public static final String JSON_PROPERTY_PIN_ENTRY_SOLUTION = "pinEntrySolution";
  private String pinEntrySolution;

  public static final String JSON_PROPERTY_DEVICE_ID = "deviceId";
  private String deviceId;

  public static final String JSON_PROPERTY_PIN_BLOCK_ENCODING_FORMAT = "pinBlockEncodingFormat";
  private Integer pinBlockEncodingFormat;

  public static final String JSON_PROPERTY_ENCRYPTED_PIN = "encryptedPin";
  private String encryptedPin;

  public static final String JSON_PROPERTY_ENCRYPTED_KEY_SERIAL_NUMBER = "encryptedKeySerialNumber";
  private String encryptedKeySerialNumber;

  public static final String JSON_PROPERTY_PARTNER_SDK_VERSION = "partnerSdkVersion";
  private String partnerSdkVersion;

  public static final String JSON_PROPERTY_EMV_APPLICATION_IDENTIFIER_AND_DEDICATED_FILE_NAME = "emvApplicationIdentifierAndDedicatedFileName";
  private String emvApplicationIdentifierAndDedicatedFileName;

  public static final String JSON_PROPERTY_TERMINAL_COMPLIANCE = "terminalCompliance";
  private String terminalCompliance;

  public static final String JSON_PROPERTY_IS_DEDICATED_HARDWARE_TERMINAL = "isDedicatedHardwareTerminal";
  private String isDedicatedHardwareTerminal;

  public static final String JSON_PROPERTY_TERMINAL_MODEL = "terminalModel";
  private String terminalModel;

  public static final String JSON_PROPERTY_TERMINAL_MAKE = "terminalMake";
  private String terminalMake;

  public static final String JSON_PROPERTY_SERVICE_CODE = "serviceCode";
  private String serviceCode;

  public CreatePaymentRequestPointOfSaleInformation() {
  }

  public CreatePaymentRequestPointOfSaleInformation terminalId(String terminalId) {
  ...
  public CreatePaymentRequestPointOfSaleInformation terminalSerialNumber(String terminalSerialNumber) {
  ...
  public CreatePaymentRequestPointOfSaleInformation cardholderVerificationMethodUsed(Integer cardholderVerificationMethodUsed) {
  ...
  public CreatePaymentRequestPointOfSaleInformation laneNumber(String laneNumber) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_LANE_NUMBER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation catLevel(Integer catLevel) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CAT_LEVEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation entryMode(String entryMode) {
  ...
  public CreatePaymentRequestPointOfSaleInformation terminalCapability(Integer terminalCapability) {
  ...
  public CreatePaymentRequestPointOfSaleInformation operatingEnvironment(String operatingEnvironment) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_OPERATING_ENVIRONMENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation emv(CreatePaymentRequestPointOfSaleInformationEmv emv) {
  ...
  public CreatePaymentRequestPointOfSaleInformationEmv getEmv() {
    return emv;
  }
  ...
  @JsonProperty(JSON_PROPERTY_EMV)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEmv(CreatePaymentRequestPointOfSaleInformationEmv emv) {
    this.emv = emv;
  }

  public CreatePaymentRequestPointOfSaleInformation amexCapnData(String amexCapnData) {
  ...
  public CreatePaymentRequestPointOfSaleInformation trackData(String trackData) {
  ...
  public CreatePaymentRequestPointOfSaleInformation storeAndForwardIndicator(String storeAndForwardIndicator) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_STORE_AND_FORWARD_INDICATOR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation cardholderVerificationMethod(List<String> cardholderVerificationMethod) {
    
    this.cardholderVerificationMethod = cardholderVerificationMethod;
    return this;
  }

  public CreatePaymentRequestPointOfSaleInformation addCardholderVerificationMethodItem(String cardholderVerificationMethodItem) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CARDHOLDER_VERIFICATION_METHOD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation terminalInputCapability(List<String> terminalInputCapability) {
    
    this.terminalInputCapability = terminalInputCapability;
    return this;
  }

  public CreatePaymentRequestPointOfSaleInformation addTerminalInputCapabilityItem(String terminalInputCapabilityItem) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TERMINAL_INPUT_CAPABILITY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation terminalCardCaptureCapability(String terminalCardCaptureCapability) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TERMINAL_CARD_CAPTURE_CAPABILITY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation terminalOutputCapability(String terminalOutputCapability) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TERMINAL_OUTPUT_CAPABILITY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation terminalPinCapability(Integer terminalPinCapability) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TERMINAL_PIN_CAPABILITY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation pinEntrySolution(String pinEntrySolution) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_PIN_ENTRY_SOLUTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation deviceId(String deviceId) {
  ...
  public CreatePaymentRequestPointOfSaleInformation pinBlockEncodingFormat(Integer pinBlockEncodingFormat) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_PIN_BLOCK_ENCODING_FORMAT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation encryptedPin(String encryptedPin) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ENCRYPTED_PIN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation encryptedKeySerialNumber(String encryptedKeySerialNumber) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ENCRYPTED_KEY_SERIAL_NUMBER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation partnerSdkVersion(String partnerSdkVersion) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_PARTNER_SDK_VERSION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation emvApplicationIdentifierAndDedicatedFileName(String emvApplicationIdentifierAndDedicatedFileName) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_EMV_APPLICATION_IDENTIFIER_AND_DEDICATED_FILE_NAME)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation terminalCompliance(String terminalCompliance) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TERMINAL_COMPLIANCE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation isDedicatedHardwareTerminal(String isDedicatedHardwareTerminal) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_IS_DEDICATED_HARDWARE_TERMINAL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation terminalModel(String terminalModel) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TERMINAL_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation terminalMake(String terminalMake) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TERMINAL_MAKE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CreatePaymentRequestPointOfSaleInformation serviceCode(String serviceCode) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePaymentRequestPointOfSaleInformation createPaymentRequestPointOfSaleInformation = (CreatePaymentRequestPointOfSaleInformation) o;
    return Objects.equals(this.terminalId, createPaymentRequestPointOfSaleInformation.terminalId) &&
        Objects.equals(this.terminalSerialNumber, createPaymentRequestPointOfSaleInformation.terminalSerialNumber) &&
        Objects.equals(this.cardholderVerificationMethodUsed, createPaymentRequestPointOfSaleInformation.cardholderVerificationMethodUsed) &&
        Objects.equals(this.laneNumber, createPaymentRequestPointOfSaleInformation.laneNumber) &&
        Objects.equals(this.catLevel, createPaymentRequestPointOfSaleInformation.catLevel) &&
        Objects.equals(this.entryMode, createPaymentRequestPointOfSaleInformation.entryMode) &&
        Objects.equals(this.terminalCapability, createPaymentRequestPointOfSaleInformation.terminalCapability) &&
        Objects.equals(this.operatingEnvironment, createPaymentRequestPointOfSaleInformation.operatingEnvironment) &&
        Objects.equals(this.emv, createPaymentRequestPointOfSaleInformation.emv) &&
        Objects.equals(this.amexCapnData, createPaymentRequestPointOfSaleInformation.amexCapnData) &&
        Objects.equals(this.trackData, createPaymentRequestPointOfSaleInformation.trackData) &&
        Objects.equals(this.storeAndForwardIndicator, createPaymentRequestPointOfSaleInformation.storeAndForwardIndicator) &&
        Objects.equals(this.cardholderVerificationMethod, createPaymentRequestPointOfSaleInformation.cardholderVerificationMethod) &&
        Objects.equals(this.terminalInputCapability, createPaymentRequestPointOfSaleInformation.terminalInputCapability) &&
        Objects.equals(this.terminalCardCaptureCapability, createPaymentRequestPointOfSaleInformation.terminalCardCaptureCapability) &&
        Objects.equals(this.terminalOutputCapability, createPaymentRequestPointOfSaleInformation.terminalOutputCapability) &&
        Objects.equals(this.terminalPinCapability, createPaymentRequestPointOfSaleInformation.terminalPinCapability) &&
        Objects.equals(this.pinEntrySolution, createPaymentRequestPointOfSaleInformation.pinEntrySolution) &&
        Objects.equals(this.deviceId, createPaymentRequestPointOfSaleInformation.deviceId) &&
        Objects.equals(this.pinBlockEncodingFormat, createPaymentRequestPointOfSaleInformation.pinBlockEncodingFormat) &&
        Objects.equals(this.encryptedPin, createPaymentRequestPointOfSaleInformation.encryptedPin) &&
        Objects.equals(this.encryptedKeySerialNumber, createPaymentRequestPointOfSaleInformation.encryptedKeySerialNumber) &&
        Objects.equals(this.partnerSdkVersion, createPaymentRequestPointOfSaleInformation.partnerSdkVersion) &&
        Objects.equals(this.emvApplicationIdentifierAndDedicatedFileName, createPaymentRequestPointOfSaleInformation.emvApplicationIdentifierAndDedicatedFileName) &&
        Objects.equals(this.terminalCompliance, createPaymentRequestPointOfSaleInformation.terminalCompliance) &&
        Objects.equals(this.isDedicatedHardwareTerminal, createPaymentRequestPointOfSaleInformation.isDedicatedHardwareTerminal) &&
        Objects.equals(this.terminalModel, createPaymentRequestPointOfSaleInformation.terminalModel) &&
        Objects.equals(this.terminalMake, createPaymentRequestPointOfSaleInformation.terminalMake) &&
        Objects.equals(this.serviceCode, createPaymentRequestPointOfSaleInformation.serviceCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePaymentRequestPointOfSaleInformation {\n");

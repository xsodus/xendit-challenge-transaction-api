 ...
 */
@JsonPropertyOrder({
  PtsV2IncrementalAuthorizationPatch201ResponseClientReferenceInformation.JSON_PROPERTY_CODE
})
@JsonTypeName("ptsV2IncrementalAuthorizationPatch201Response_clientReferenceInformation")

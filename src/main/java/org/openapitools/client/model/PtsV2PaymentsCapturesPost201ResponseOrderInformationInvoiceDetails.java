 ...
 */
@JsonPropertyOrder({
  PtsV2PaymentsCapturesPost201ResponseOrderInformationInvoiceDetails.JSON_PROPERTY_LEVEL3_TRANSMISSION_STATUS
})
@JsonTypeName("ptsV2PaymentsCapturesPost201Response_orderInformation_invoiceDetails")

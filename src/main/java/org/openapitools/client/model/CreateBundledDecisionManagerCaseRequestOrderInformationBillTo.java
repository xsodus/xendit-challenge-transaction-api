...
/**
 * CreateBundledDecisionManagerCaseRequestOrderInformationBillTo
 */
@JsonPropertyOrder({
  CreateBundledDecisionManagerCaseRequestOrderInformationBillTo.JSON_PROPERTY_ADDRESS1,
  CreateBundledDecisionManagerCaseRequestOrderInformationBillTo.JSON_PROPERTY_ADDRESS2,
  CreateBundledDecisionManagerCaseRequestOrderInformationBillTo.JSON_PROPERTY_ADMINISTRATIVE_AREA,
  CreateBundledDecisionManagerCaseRequestOrderInformationBillTo.JSON_PROPERTY_COUNTRY,
  CreateBundledDecisionManagerCaseRequestOrderInformationBillTo.JSON_PROPERTY_LOCALITY,
  CreateBundledDecisionManagerCaseRequestOrderInformationBillTo.JSON_PROPERTY_FIRST_NAME,
  CreateBundledDecisionManagerCaseRequestOrderInformationBillTo.JSON_PROPERTY_LAST_NAME,
  CreateBundledDecisionManagerCaseRequestOrderInformationBillTo.JSON_PROPERTY_PHONE_NUMBER,
  CreateBundledDecisionManagerCaseRequestOrderInformationBillTo.JSON_PROPERTY_EMAIL,
  CreateBundledDecisionManagerCaseRequestOrderInformationBillTo.JSON_PROPERTY_POSTAL_CODE
})
@JsonTypeName("createBundledDecisionManagerCase_request_orderInformation_billTo")
//@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-11-09T19:17:21.826843+07:00[Asia/Bangkok]", comments = "Generator version: 7.9.0")
public class CreateBundledDecisionManagerCaseRequestOrderInformationBillTo {
  ...
  public CreateBundledDecisionManagerCaseRequestOrderInformationBillTo() {
  }

  public CreateBundledDecisionManagerCaseRequestOrderInformationBillTo address1(String address1) {
  ...
  public CreateBundledDecisionManagerCaseRequestOrderInformationBillTo address2(String address2) {
  ...
  public CreateBundledDecisionManagerCaseRequestOrderInformationBillTo administrativeArea(String administrativeArea) {
  ...
  public CreateBundledDecisionManagerCaseRequestOrderInformationBillTo country(String country) {
  ...
  public CreateBundledDecisionManagerCaseRequestOrderInformationBillTo locality(String locality) {
  ...
  public CreateBundledDecisionManagerCaseRequestOrderInformationBillTo firstName(String firstName) {
  ...
  public CreateBundledDecisionManagerCaseRequestOrderInformationBillTo lastName(String lastName) {
  ...
  public CreateBundledDecisionManagerCaseRequestOrderInformationBillTo phoneNumber(String phoneNumber) {
  ...
  public CreateBundledDecisionManagerCaseRequestOrderInformationBillTo email(String email) {
  ...
  public CreateBundledDecisionManagerCaseRequestOrderInformationBillTo postalCode(String postalCode) {
  ...
  public boolean equals(Object o) {
    ...
    CreateBundledDecisionManagerCaseRequestOrderInformationBillTo createBundledDecisionManagerCaseRequestOrderInformationBillTo = (CreateBundledDecisionManagerCaseRequestOrderInformationBillTo) o;
    return Objects.equals(this.address1, createBundledDecisionManagerCaseRequestOrderInformationBillTo.address1) &&
        Objects.equals(this.address2, createBundledDecisionManagerCaseRequestOrderInformationBillTo.address2) &&
        Objects.equals(this.administrativeArea, createBundledDecisionManagerCaseRequestOrderInformationBillTo.administrativeArea) &&
        Objects.equals(this.country, createBundledDecisionManagerCaseRequestOrderInformationBillTo.country) &&
        Objects.equals(this.locality, createBundledDecisionManagerCaseRequestOrderInformationBillTo.locality) &&
        Objects.equals(this.firstName, createBundledDecisionManagerCaseRequestOrderInformationBillTo.firstName) &&
        Objects.equals(this.lastName, createBundledDecisionManagerCaseRequestOrderInformationBillTo.lastName) &&
        Objects.equals(this.phoneNumber, createBundledDecisionManagerCaseRequestOrderInformationBillTo.phoneNumber) &&
        Objects.equals(this.email, createBundledDecisionManagerCaseRequestOrderInformationBillTo.email) &&
        Objects.equals(this.postalCode, createBundledDecisionManagerCaseRequestOrderInformationBillTo.postalCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateBundledDecisionManagerCaseRequestOrderInformationBillTo {\n");

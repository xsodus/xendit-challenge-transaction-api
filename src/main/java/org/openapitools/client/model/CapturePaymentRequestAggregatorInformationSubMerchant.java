...
/**
 * CapturePaymentRequestAggregatorInformationSubMerchant
 */
@JsonPropertyOrder({
  CapturePaymentRequestAggregatorInformationSubMerchant.JSON_PROPERTY_NAME,
  CapturePaymentRequestAggregatorInformationSubMerchant.JSON_PROPERTY_ADDRESS1,
  CapturePaymentRequestAggregatorInformationSubMerchant.JSON_PROPERTY_LOCALITY,
  CapturePaymentRequestAggregatorInformationSubMerchant.JSON_PROPERTY_ADMINISTRATIVE_AREA,
  CapturePaymentRequestAggregatorInformationSubMerchant.JSON_PROPERTY_POSTAL_CODE,
  CapturePaymentRequestAggregatorInformationSubMerchant.JSON_PROPERTY_COUNTRY,
  CapturePaymentRequestAggregatorInformationSubMerchant.JSON_PROPERTY_EMAIL,
  CapturePaymentRequestAggregatorInformationSubMerchant.JSON_PROPERTY_PHONE_NUMBER,
  CapturePaymentRequestAggregatorInformationSubMerchant.JSON_PROPERTY_ID
})
@JsonTypeName("capturePayment_request_aggregatorInformation_subMerchant")
//@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-11-09T19:17:21.826843+07:00[Asia/Bangkok]", comments = "Generator version: 7.9.0")
public class CapturePaymentRequestAggregatorInformationSubMerchant {
  ...
  public CapturePaymentRequestAggregatorInformationSubMerchant() {
  }

  public CapturePaymentRequestAggregatorInformationSubMerchant name(String name) {
  ...
  public CapturePaymentRequestAggregatorInformationSubMerchant address1(String address1) {
  ...
  public CapturePaymentRequestAggregatorInformationSubMerchant locality(String locality) {
  ...
  public CapturePaymentRequestAggregatorInformationSubMerchant administrativeArea(String administrativeArea) {
  ...
  public CapturePaymentRequestAggregatorInformationSubMerchant postalCode(String postalCode) {
  ...
  public CapturePaymentRequestAggregatorInformationSubMerchant country(String country) {
  ...
  public CapturePaymentRequestAggregatorInformationSubMerchant email(String email) {
  ...
  public CapturePaymentRequestAggregatorInformationSubMerchant phoneNumber(String phoneNumber) {
  ...
  public CapturePaymentRequestAggregatorInformationSubMerchant id(String id) {
  ...
  public boolean equals(Object o) {
    ...
    CapturePaymentRequestAggregatorInformationSubMerchant capturePaymentRequestAggregatorInformationSubMerchant = (CapturePaymentRequestAggregatorInformationSubMerchant) o;
    return Objects.equals(this.name, capturePaymentRequestAggregatorInformationSubMerchant.name) &&
        Objects.equals(this.address1, capturePaymentRequestAggregatorInformationSubMerchant.address1) &&
        Objects.equals(this.locality, capturePaymentRequestAggregatorInformationSubMerchant.locality) &&
        Objects.equals(this.administrativeArea, capturePaymentRequestAggregatorInformationSubMerchant.administrativeArea) &&
        Objects.equals(this.postalCode, capturePaymentRequestAggregatorInformationSubMerchant.postalCode) &&
        Objects.equals(this.country, capturePaymentRequestAggregatorInformationSubMerchant.country) &&
        Objects.equals(this.email, capturePaymentRequestAggregatorInformationSubMerchant.email) &&
        Objects.equals(this.phoneNumber, capturePaymentRequestAggregatorInformationSubMerchant.phoneNumber) &&
        Objects.equals(this.id, capturePaymentRequestAggregatorInformationSubMerchant.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class CapturePaymentRequestAggregatorInformationSubMerchant {\n");

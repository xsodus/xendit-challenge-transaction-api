 ...
 */
@JsonPropertyOrder({
  PtsV2PaymentsPost201ResponseRiskInformationIpAddress.JSON_PROPERTY_ANONYMIZER_STATUS,
  PtsV2PaymentsPost201ResponseRiskInformationIpAddress.JSON_PROPERTY_LOCALITY,
  PtsV2PaymentsPost201ResponseRiskInformationIpAddress.JSON_PROPERTY_COUNTRY,
  PtsV2PaymentsPost201ResponseRiskInformationIpAddress.JSON_PROPERTY_ADMINISTRATIVE_AREA,
  PtsV2PaymentsPost201ResponseRiskInformationIpAddress.JSON_PROPERTY_ROUTING_METHOD,
  PtsV2PaymentsPost201ResponseRiskInformationIpAddress.JSON_PROPERTY_CARRIER,
  PtsV2PaymentsPost201ResponseRiskInformationIpAddress.JSON_PROPERTY_ORGANIZATION
})
@JsonTypeName("ptsV2PaymentsPost201Response_riskInformation_ipAddress")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-11-09T18:32:10.370382+07:00[Asia/Bangkok]", comments = "Generator version: 7.9.0")
public class PtsV2PaymentsPost201ResponseRiskInformationIpAddress {
  public static final String JSON_PROPERTY_ANONYMIZER_STATUS = "anonymizerStatus";
  ...
  public static final String JSON_PROPERTY_ROUTING_METHOD = "routingMethod";
  ...
  @JsonProperty(JSON_PROPERTY_ANONYMIZER_STATUS)
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ROUTING_METHOD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

 ...
 */
@JsonPropertyOrder({
  PtsV2PaymentsPost201ResponsePointOfSaleInformationEmv.JSON_PROPERTY_TAGS,
  PtsV2PaymentsPost201ResponsePointOfSaleInformationEmv.JSON_PROPERTY_CHIP_VALIDATION_TYPE,
  PtsV2PaymentsPost201ResponsePointOfSaleInformationEmv.JSON_PROPERTY_CHIP_VALIDATION_RESULT
})
@JsonTypeName("ptsV2PaymentsPost201Response_pointOfSaleInformation_emv")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-11-09T18:32:10.370382+07:00[Asia/Bangkok]", comments = "Generator version: 7.9.0")
public class PtsV2PaymentsPost201ResponsePointOfSaleInformationEmv {
  public static final String JSON_PROPERTY_TAGS = "tags";
  private String tags;

  public static final String JSON_PROPERTY_CHIP_VALIDATION_TYPE = "chipValidationType";
  private String chipValidationType;

  public static final String JSON_PROPERTY_CHIP_VALIDATION_RESULT = "chipValidationResult";
  private String chipValidationResult;
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CHIP_VALIDATION_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CHIP_VALIDATION_RESULT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

...
/**
 * OctCreatePaymentRequestOrderInformationBillTo
 */
@JsonPropertyOrder({
  OctCreatePaymentRequestOrderInformationBillTo.JSON_PROPERTY_FIRST_NAME,
  OctCreatePaymentRequestOrderInformationBillTo.JSON_PROPERTY_LAST_NAME,
  OctCreatePaymentRequestOrderInformationBillTo.JSON_PROPERTY_ADDRESS1,
  OctCreatePaymentRequestOrderInformationBillTo.JSON_PROPERTY_ADDRESS2,
  OctCreatePaymentRequestOrderInformationBillTo.JSON_PROPERTY_COUNTRY,
  OctCreatePaymentRequestOrderInformationBillTo.JSON_PROPERTY_LOCALITY,
  OctCreatePaymentRequestOrderInformationBillTo.JSON_PROPERTY_ADMINISTRATIVE_AREA,
  OctCreatePaymentRequestOrderInformationBillTo.JSON_PROPERTY_POSTAL_CODE,
  OctCreatePaymentRequestOrderInformationBillTo.JSON_PROPERTY_PHONE_NUMBER,
  OctCreatePaymentRequestOrderInformationBillTo.JSON_PROPERTY_PHONE_TYPE
})
@JsonTypeName("octCreatePayment_request_orderInformation_billTo")
//@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-11-09T19:17:21.826843+07:00[Asia/Bangkok]", comments = "Generator version: 7.9.0")
public class OctCreatePaymentRequestOrderInformationBillTo {
  ...
  public OctCreatePaymentRequestOrderInformationBillTo() {
  }

  public OctCreatePaymentRequestOrderInformationBillTo firstName(String firstName) {
  ...
  public OctCreatePaymentRequestOrderInformationBillTo lastName(String lastName) {
  ...
  public OctCreatePaymentRequestOrderInformationBillTo address1(String address1) {
  ...
  public OctCreatePaymentRequestOrderInformationBillTo address2(String address2) {
  ...
  public OctCreatePaymentRequestOrderInformationBillTo country(String country) {
  ...
  public OctCreatePaymentRequestOrderInformationBillTo locality(String locality) {
  ...
  public OctCreatePaymentRequestOrderInformationBillTo administrativeArea(String administrativeArea) {
  ...
  public OctCreatePaymentRequestOrderInformationBillTo postalCode(String postalCode) {
  ...
  public OctCreatePaymentRequestOrderInformationBillTo phoneNumber(String phoneNumber) {
  ...
  public OctCreatePaymentRequestOrderInformationBillTo phoneType(String phoneType) {
  ...
  public boolean equals(Object o) {
    ...
    OctCreatePaymentRequestOrderInformationBillTo octCreatePaymentRequestOrderInformationBillTo = (OctCreatePaymentRequestOrderInformationBillTo) o;
    return Objects.equals(this.firstName, octCreatePaymentRequestOrderInformationBillTo.firstName) &&
        Objects.equals(this.lastName, octCreatePaymentRequestOrderInformationBillTo.lastName) &&
        Objects.equals(this.address1, octCreatePaymentRequestOrderInformationBillTo.address1) &&
        Objects.equals(this.address2, octCreatePaymentRequestOrderInformationBillTo.address2) &&
        Objects.equals(this.country, octCreatePaymentRequestOrderInformationBillTo.country) &&
        Objects.equals(this.locality, octCreatePaymentRequestOrderInformationBillTo.locality) &&
        Objects.equals(this.administrativeArea, octCreatePaymentRequestOrderInformationBillTo.administrativeArea) &&
        Objects.equals(this.postalCode, octCreatePaymentRequestOrderInformationBillTo.postalCode) &&
        Objects.equals(this.phoneNumber, octCreatePaymentRequestOrderInformationBillTo.phoneNumber) &&
        Objects.equals(this.phoneType, octCreatePaymentRequestOrderInformationBillTo.phoneType);
  }
  ...
  public String toString() {
    ...
    sb.append("class OctCreatePaymentRequestOrderInformationBillTo {\n");

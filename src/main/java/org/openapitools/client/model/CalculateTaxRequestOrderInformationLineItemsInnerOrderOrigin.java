 ...
 */
@JsonPropertyOrder({
  CalculateTaxRequestOrderInformationLineItemsInnerOrderOrigin.JSON_PROPERTY_LOCALITY,
  CalculateTaxRequestOrderInformationLineItemsInnerOrderOrigin.JSON_PROPERTY_ADMINISTRATIVE_AREA,
  CalculateTaxRequestOrderInformationLineItemsInnerOrderOrigin.JSON_PROPERTY_POSTAL_CODE,
  CalculateTaxRequestOrderInformationLineItemsInnerOrderOrigin.JSON_PROPERTY_COUNTRY
})
@JsonTypeName("calculateTax_request_orderInformation_lineItems_inner_orderOrigin")
//@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-11-09T19:17:21.826843+07:00[Asia/Bangkok]", comments = "Generator version: 7.9.0")
public class CalculateTaxRequestOrderInformationLineItemsInnerOrderOrigin {
  ...
  public CalculateTaxRequestOrderInformationLineItemsInnerOrderOrigin() {
  }

  public CalculateTaxRequestOrderInformationLineItemsInnerOrderOrigin locality(String locality) {
  ...
  public CalculateTaxRequestOrderInformationLineItemsInnerOrderOrigin administrativeArea(String administrativeArea) {
  ...
  public CalculateTaxRequestOrderInformationLineItemsInnerOrderOrigin postalCode(String postalCode) {
  ...
  public CalculateTaxRequestOrderInformationLineItemsInnerOrderOrigin country(String country) {
  ...
  public boolean equals(Object o) {
    ...
    CalculateTaxRequestOrderInformationLineItemsInnerOrderOrigin calculateTaxRequestOrderInformationLineItemsInnerOrderOrigin = (CalculateTaxRequestOrderInformationLineItemsInnerOrderOrigin) o;
    return Objects.equals(this.locality, calculateTaxRequestOrderInformationLineItemsInnerOrderOrigin.locality) &&
        Objects.equals(this.administrativeArea, calculateTaxRequestOrderInformationLineItemsInnerOrderOrigin.administrativeArea) &&
        Objects.equals(this.postalCode, calculateTaxRequestOrderInformationLineItemsInnerOrderOrigin.postalCode) &&
        Objects.equals(this.country, calculateTaxRequestOrderInformationLineItemsInnerOrderOrigin.country);
  }
  ...
  public String toString() {
    ...
    sb.append("class CalculateTaxRequestOrderInformationLineItemsInnerOrderOrigin {\n");

...
/**
 * CreatePaymentRequestClientReferenceInformationPartner
 */
@JsonPropertyOrder({
  CreatePaymentRequestClientReferenceInformationPartner.JSON_PROPERTY_ORIGINAL_TRANSACTION_ID,
  CreatePaymentRequestClientReferenceInformationPartner.JSON_PROPERTY_DEVELOPER_ID,
  CreatePaymentRequestClientReferenceInformationPartner.JSON_PROPERTY_SOLUTION_ID,
  CreatePaymentRequestClientReferenceInformationPartner.JSON_PROPERTY_THIRD_PARTY_CERTIFICATION_NUMBER
})
@JsonTypeName("createPayment_request_clientReferenceInformation_partner")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-11-09T18:32:10.370382+07:00[Asia/Bangkok]", comments = "Generator version: 7.9.0")
public class CreatePaymentRequestClientReferenceInformationPartner {
  ...
  public CreatePaymentRequestClientReferenceInformationPartner() {
  }

  public CreatePaymentRequestClientReferenceInformationPartner originalTransactionId(String originalTransactionId) {
  ...
  public CreatePaymentRequestClientReferenceInformationPartner developerId(String developerId) {
  ...
  public CreatePaymentRequestClientReferenceInformationPartner solutionId(String solutionId) {
  ...
  public CreatePaymentRequestClientReferenceInformationPartner thirdPartyCertificationNumber(String thirdPartyCertificationNumber) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePaymentRequestClientReferenceInformationPartner createPaymentRequestClientReferenceInformationPartner = (CreatePaymentRequestClientReferenceInformationPartner) o;
    return Objects.equals(this.originalTransactionId, createPaymentRequestClientReferenceInformationPartner.originalTransactionId) &&
        Objects.equals(this.developerId, createPaymentRequestClientReferenceInformationPartner.developerId) &&
        Objects.equals(this.solutionId, createPaymentRequestClientReferenceInformationPartner.solutionId) &&
        Objects.equals(this.thirdPartyCertificationNumber, createPaymentRequestClientReferenceInformationPartner.thirdPartyCertificationNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePaymentRequestClientReferenceInformationPartner {\n");

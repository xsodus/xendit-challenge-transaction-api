...
/**
 * BillingAgreementsRegistrationRequestProcessingInformation
 */
@JsonPropertyOrder({
  BillingAgreementsRegistrationRequestProcessingInformation.JSON_PROPERTY_COMMERCE_INDICATOR,
  BillingAgreementsRegistrationRequestProcessingInformation.JSON_PROPERTY_ACTION_LIST
})
@JsonTypeName("billingAgreementsRegistration_request_processingInformation")
//@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-11-09T19:17:21.826843+07:00[Asia/Bangkok]", comments = "Generator version: 7.9.0")
public class BillingAgreementsRegistrationRequestProcessingInformation {
  ...
  public BillingAgreementsRegistrationRequestProcessingInformation() {
  }

  public BillingAgreementsRegistrationRequestProcessingInformation commerceIndicator(String commerceIndicator) {
  ...
  public BillingAgreementsRegistrationRequestProcessingInformation actionList(List<String> actionList) {
    
    this.actionList = actionList;
    return this;
  }

  public BillingAgreementsRegistrationRequestProcessingInformation addActionListItem(String actionListItem) {
  ...
  public boolean equals(Object o) {
    ...
    BillingAgreementsRegistrationRequestProcessingInformation billingAgreementsRegistrationRequestProcessingInformation = (BillingAgreementsRegistrationRequestProcessingInformation) o;
    return Objects.equals(this.commerceIndicator, billingAgreementsRegistrationRequestProcessingInformation.commerceIndicator) &&
        Objects.equals(this.actionList, billingAgreementsRegistrationRequestProcessingInformation.actionList);
  }
  ...
  public String toString() {
    ...
    sb.append("class BillingAgreementsRegistrationRequestProcessingInformation {\n");

...
/**
 * CapturePaymentRequestMerchantInformation
 */
@JsonPropertyOrder({
  CapturePaymentRequestMerchantInformation.JSON_PROPERTY_MERCHANT_DESCRIPTOR,
  CapturePaymentRequestMerchantInformation.JSON_PROPERTY_CARD_ACCEPTOR_REFERENCE_NUMBER,
  CapturePaymentRequestMerchantInformation.JSON_PROPERTY_CATEGORY_CODE,
  CapturePaymentRequestMerchantInformation.JSON_PROPERTY_VAT_REGISTRATION_NUMBER,
  CapturePaymentRequestMerchantInformation.JSON_PROPERTY_SERVICE_FEE_DESCRIPTOR,
  CapturePaymentRequestMerchantInformation.JSON_PROPERTY_TAX_ID
})
@JsonTypeName("capturePayment_request_merchantInformation")
//@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-11-09T19:17:21.826843+07:00[Asia/Bangkok]", comments = "Generator version: 7.9.0")
public class CapturePaymentRequestMerchantInformation {
  ...
  public CapturePaymentRequestMerchantInformation() {
  }

  public CapturePaymentRequestMerchantInformation merchantDescriptor(CreatePaymentRequestMerchantInformationMerchantDescriptor merchantDescriptor) {
  ...
  public CapturePaymentRequestMerchantInformation cardAcceptorReferenceNumber(String cardAcceptorReferenceNumber) {
  ...
  public CapturePaymentRequestMerchantInformation categoryCode(Integer categoryCode) {
  ...
  public CapturePaymentRequestMerchantInformation vatRegistrationNumber(String vatRegistrationNumber) {
  ...
  public CapturePaymentRequestMerchantInformation serviceFeeDescriptor(CreatePaymentRequestMerchantInformationServiceFeeDescriptor serviceFeeDescriptor) {
  ...
  public CapturePaymentRequestMerchantInformation taxId(String taxId) {
  ...
  public boolean equals(Object o) {
    ...
    CapturePaymentRequestMerchantInformation capturePaymentRequestMerchantInformation = (CapturePaymentRequestMerchantInformation) o;
    return Objects.equals(this.merchantDescriptor, capturePaymentRequestMerchantInformation.merchantDescriptor) &&
        Objects.equals(this.cardAcceptorReferenceNumber, capturePaymentRequestMerchantInformation.cardAcceptorReferenceNumber) &&
        Objects.equals(this.categoryCode, capturePaymentRequestMerchantInformation.categoryCode) &&
        Objects.equals(this.vatRegistrationNumber, capturePaymentRequestMerchantInformation.vatRegistrationNumber) &&
        Objects.equals(this.serviceFeeDescriptor, capturePaymentRequestMerchantInformation.serviceFeeDescriptor) &&
        Objects.equals(this.taxId, capturePaymentRequestMerchantInformation.taxId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CapturePaymentRequestMerchantInformation {\n");

 ...
 */
@JsonPropertyOrder({
  PtsV2PaymentsPost201ResponseIssuerInformation.JSON_PROPERTY_COUNTRY,
  PtsV2PaymentsPost201ResponseIssuerInformation.JSON_PROPERTY_DISCRETIONARY_DATA,
  PtsV2PaymentsPost201ResponseIssuerInformation.JSON_PROPERTY_COUNTRY_SPECIFIC_DISCRETIONARY_DATA,
  PtsV2PaymentsPost201ResponseIssuerInformation.JSON_PROPERTY_RESPONSE_CODE,
  PtsV2PaymentsPost201ResponseIssuerInformation.JSON_PROPERTY_PIN_REQUEST_INDICATOR
})
@JsonTypeName("ptsV2PaymentsPost201Response_issuerInformation")
...
public class PtsV2PaymentsPost201ResponseIssuerInformation {
  ...
  public static final String JSON_PROPERTY_COUNTRY_SPECIFIC_DISCRETIONARY_DATA = "countrySpecificDiscretionaryData";
  private String countrySpecificDiscretionaryData;

  public static final String JSON_PROPERTY_RESPONSE_CODE = "responseCode";
  private String responseCode;

  public static final String JSON_PROPERTY_PIN_REQUEST_INDICATOR = "pinRequestIndicator";
  private String pinRequestIndicator;
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_COUNTRY_SPECIFIC_DISCRETIONARY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_PIN_REQUEST_INDICATOR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

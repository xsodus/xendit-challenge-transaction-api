 ...
 */
@JsonPropertyOrder({
  V1FileDetailsGet200ResponseLinksSelf.JSON_PROPERTY_HREF,
  V1FileDetailsGet200ResponseLinksSelf.JSON_PROPERTY_METHOD
})
@JsonTypeName("V1FileDetailsGet200Response__links_self")
